...
namespace StayInTarkov.Coop
{
    ...
    /// Description: Based on ModulePatch by the SPT-Spt team. This adds a Replicated method for packets to process through.
    /// </summary>
    public abstract class ModuleReplicationPatch : ModulePatch, IModuleReplicationPatch
    {
        ...
        {
            if (SptBackendCommunication.Instance.HighPingMode && player.IsYourPlayer)
                return true;
