...
namespace StayInTarkov.Coop.Components.CoopGameComponents
{
    ...
    public class SITGameComponent : MonoBehaviour
    {
        ...
        private SptBackendCommunication RequestingObj { get; set; }
        public SITConfig SITConfig { get; private set; } = new SITConfig();
        public string ServerId { get; set; } = null;
        public long Timestamp { get; set; } = 0;
        public ushort SptBackendPing = 0;
        ...
        async void Start()
        {
            ...
            // Instantiate the Requesting Object for Spt Communication
            RequestingObj = SptBackendCommunication.GetRequestInstance(false, Logger);
        ...
        private void GameWorld_AfterGameStarted()
        {
            ...
            //{
            //    // Send My Player to Spt, so that other clients know about me
