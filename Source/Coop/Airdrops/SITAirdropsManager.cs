...
using StayInTarkov;
using StayInTarkov.SptSupport.Airdrops;
using StayInTarkov.SptSupport.Airdrops.Models;
using StayInTarkov.SptSupport.Airdrops.Utils;
...
namespace Spt.Custom.Airdrops
{
    ...
    /// Link: https://dev.sp-tarkov.com/SPT-AKI/Modules/src/branch/master/project/Spt.Custom/Airdrops/AirdropsManager.cs
