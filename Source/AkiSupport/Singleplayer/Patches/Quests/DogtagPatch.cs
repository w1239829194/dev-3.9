...
namespace StayInTarkov.SptSupport.Singleplayer.Patches.Quests
{
    /// <summary>
    /// Credit SPT-Spt team
    /// Link: https://dev.sp-tarkov.com/SPT-AKI/Modules/src/branch/master/project/Spt.SinglePlayer/Patches/Quests/DogtagPatch.cs
