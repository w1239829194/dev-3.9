...
namespace StayInTarkov.SptSupport.Singleplayer.Patches.RaidFix
{
    ...
    /// Link: https://dev.sp-tarkov.com/SPT-AKI/Modules/src/branch/master/project/Spt.SinglePlayer/Patches/RaidFix/GetNewBotTemplatesPatch.cs
    /// </summary>
    public class GetNewBotTemplatesPatch : ModulePatch
    {
        ...
        private static bool PatchPrefix(ref Task<Profile> __result, BotsPresets __instance, List<Profile> ___list_0, CreationData data, ref bool withDelete)
        {
            ...
            */
            ...
            var continuation = new Spt.Custom.Models.BundleLoader(taskScheduler);
