...
using EFT;
using StayInTarkov.SptSupport.Singleplayer.Models.ScavMode;
using StayInTarkov;
using System;
...
namespace StayInTarkov.SptSupport.Singleplayer.Patches.ScavMode
{
    /// <summary>
    ...
    public class ScavLateStartPatch : ModulePatch
    {
        ...
        private static bool PatchPrefix(ref RaidSettings ____raidSettings)
        {
            ...
            var json = SptBackendCommunication.Instance.PostJsonBLOCKING("/singleplayer/settings/getRaidTime", Json.Serialize(request));
