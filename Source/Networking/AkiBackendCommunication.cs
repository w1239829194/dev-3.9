...
{
    public class SptBackendCommunication : IDisposable
    {
        ...
        private static SptBackendCommunication? m_Instance;
        public static SptBackendCommunication Instance
        {
            get
            {
                if (m_Instance == null || m_Instance.ProfileId == null || m_Instance.RemoteEndPoint == null)
                    m_Instance = new SptBackendCommunication();
        ...
        protected SptBackendCommunication(ManualLogSource logger = null)
        {
        ...
        private void ConnectToSptBackend()
        {
        ...
        public static SptBackendCommunication GetRequestInstance(bool createInstance = false, ManualLogSource logger = null)
        {
            if (createInstance)
            {
                return new SptBackendCommunication(logger);
            }
        ...
        public async Task<string> PostJsonAsync(string url, string data, int timeout = DEFAULT_TIMEOUT_MS, int retryAttempts = 5, bool debug = false)
        {
            ...
            throw new Exception($"Unable to communicate with Spt Server {url} to post json data: {data}");
        }
